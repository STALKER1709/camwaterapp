...
from .config import COLONNES, MARQUEUR_A_VERIFIER, MARQUEUR_ILLISIBLE
...
class LigneFacture:
    ...
    def marquer(self, statut: str, anomalie: Optional[str] = None) -> None:
        """Dégrade le statut de la ligne (OK → À_VÉRIFIER → ILLISIBLE)."""
        ordre = {STATUT_OK: 0, MARQUEUR_A_VERIFIER: 1, MARQUEUR_ILLISIBLE: 2}
